...
function StatsController:updateStatsValues()
    ...
    set("splitCountBirchLogStand", stand.splitCountBirchLogStand)
    set("splitCountBirchShortStand", stand.splitCountBirchShortStand)
    set("splitCountBirchPulpwoodStand", stand.splitCountBirchPulpwoodStand)
    ...
    set("cubicMetreBirchLogStand", stand.cubicMetreBirchLogStand, " m³")
    set("cubicMetreBirchShortStand", stand.cubicMetreBirchShortStand, " m³")
    set("cubicMetreBirchPulpwoodStand", stand.cubicMetreBirchPulpwoodStand, " m³")
