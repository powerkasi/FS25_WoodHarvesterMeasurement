...
Stand = {
    ...
    splitCountBirchLogStand        = 0,
    splitCountBirchShortStand      = 0,
    splitCountBirchPulpwoodStand   = 0,
    ...
    cubicMetreBirchLogStand        = 0.0,
    cubicMetreBirchShortStand      = 0.0,
    cubicMetreBirchPulpwoodStand   = 0.0,
...
function Stand:new(o)
    ...
    o.splitCountBirchLogStand = o.splitCountBirchLogStand or self.splitCountBirchLogStand
    o.splitCountBirchShortStand = o.splitCountBirchShortStand or self.splitCountBirchShortStand
    o.splitCountBirchPulpwoodStand = o.splitCountBirchPulpwoodStand or self.splitCountBirchPulpwoodStand
    ...
    o.cubicMetreBirchLogStand = o.cubicMetreBirchLogStand or self.cubicMetreBirchLogStand
    o.cubicMetreBirchShortStand = o.cubicMetreBirchShortStand or self.cubicMetreBirchShortStand
    o.cubicMetreBirchPulpwoodStand = o.cubicMetreBirchPulpwoodStand or self.cubicMetreBirchPulpwoodStand
